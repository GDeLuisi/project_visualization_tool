...
@mark.parametrize("paths,suffixes,date_range",[((Path("src/app/app.py"),"tests/report.txt","tests/test_dummy.py","tests/test_file_parser.py"),(".py",".json"),(date.fromisoformat("2025-02-01"),date.fromisoformat("2025-02-11"))),((".github/workflows/test-dev.yml",".github/workflows/testpypi_publish.yml",".gitignore","LICENSE","RAD.docx","README.md","main.py","pyproject.toml","requirements.txt","src/_internal/__init__.py","src/_internal/data_preprocessing.py","src/_internal/data_typing.py","src/_internal/file_parser.py","src/_internal/git_mining.py","src/_internal/info/ext.json","src/app/__init__.py","src/app/app.py","src/app/cli.py","src/gui/__init__.py","src/gui/components.py","src/gui/pages/homepage.py","src/utility/__init__.py","src/utility/logging_configs/logs_config_file.json","src/utility/logging_configs/logs_config_file_old.json","src/utility/logs.py","tests/test_cli.py","tests/test_data_preprocessing.py"),(".py",".json"),(date.fromisoformat("2025-02-01"),date.fromisoformat("2025-02-11"))),((),(".py",".json"),(date.fromisoformat("2025-02-01"),date.fromisoformat("2025-02-12"))),((),(),(date.fromisoformat("2025-02-01"),date.fromisoformat("2025-02-12"))),((),(),(date.fromisoformat("2025-02-01"),None)),((),(),(None,date.fromisoformat("2025-02-12"))),((),(),())])
